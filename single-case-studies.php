...
<div id="secondary-navigation">
	<div class="row">	
		...
		<span>Case Studies</span>
			...
			<li class="previous">
				<?php next_post_link( '%link', 'Previous Case Study' . _x( '', 'Next post link', 'twentyten' ) . '' ); ?>
			</li>
			...
			if (have_posts()) :
				...
				<li class="pager <?php if($IDOutsideLoop == $post->ID) print 'active' ?>" ><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></li>
			<?php endwhile; endif; ?>
	
			<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				
			<li class="next">
				<?php previous_post_link( '%link', '' . _x( '', 'Previous post link', 'twentyten' ) . ' Next Case Study' ); ?>
			</li>
